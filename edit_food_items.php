...
<html>
  ...
  <head>
    <title> Manager Login | Healthy treats' </title>
  </head>
    ...
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_food_items.php" class="list-group-item ">Delete Food Items</a>
    	        <a href="index feed admin.php" class="list-group-item">feedback report</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Change image : </label>
          <input type="text" class="form-control" id="ddescription" name="ddescription" value=<?php echo $row1['images_path'];  ?> placeholder="Edit image" required="">
          </div>
